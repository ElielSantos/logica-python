...
def consultarFuncionario():
   ...
   while True:
    ...
    opcaoConsultar=input('Escolha a opção desejada:\n'+
                       ...
                       '3-Remover Funcionário(s) por SETOR:\n'+
                       '4-Retornar\n'+
                       '>>>')
    if opcaoConsultar=='1':
       ...
       for funcionario in listaFuncionarios:#FUNCIONARIO VAI VARRER TODA LISTA DE FUNCIONÁRIOS#
         print('............................')
         for kay, value in funcionario.items():#VARRER TODOS OS CONJUNTOS CHAVES E VALOR DO DICIONARIO FUNCIONÁRIO#
           print('{}: {}'.format(kay, value))
         print('............................')

    elif opcaoConsultar == '2':
       print('Escolheu opção consultar funcionário por CÓDICO!')
       valorDesejado=input('Escolha o CÓDICO:')
       ...
       print('Escolheu opção remover funcionário(s) por SETOR!')
       valorDesejado=input('Escolha o SETOR:')
       for funcionario in listaFuncionarios:
...
def removerFuncionario():
   ...
   valorDesejado = int(input('Escoha o CÓDICO do produto:'))
   for funcionario in listaFuncionarios:
    if funcionario['códico']==valorDesejado:
